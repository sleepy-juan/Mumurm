        ...
        return(
            <Fragment>
                <Card style={{position:"absolute", top: y, left: x, padding:10}}>
                    ...
                    <Card.Content description="How restful is it?"/>
                    <Rating onRate={this.props._saveRating} maxRating={5}/>
                    <Button onClick={this.props._onAddLabel} basic style={{marginTop: 10}}><Icon name="tag"/>Submit!</Button>
